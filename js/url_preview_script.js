...
(()=>{
  ...
  Symbol.for("lit-noChange"))
    ...
    , j = (t,e)=>{
      ...
      for (let e = 0; e < i; e++) {
          ...
          null !== a); )
              d = r.lastIndex,
              r === E ? "!--" === a[1] ? r = S : void 0 !== a[1] ? r = C : void 0 !== a[2] ? (O.test(a[2]) && (s = RegExp("</" + a[2], "g")),
              r = P) : void 0 !== a[3] && (r = P) : r === P ? ">" === a[0] ? (r = null != s ? s : E,
              h = -1) : void 0 === a[1] ? h = -2 : (h = r.lastIndex - a[2].length,
              l = a[1],
              r = void 0 === a[3] ? P : '"' === a[3] ? H : U) : r === H || r === U ? r = P : r === S || r === C ? r = E : (r = P,
              s = void 0);
          const c = r === P && t[e + 1].startsWith("/>") ? " " : "";
          o += r === E ? i + A : h >= 0 ? (n.push(l),
          i.slice(0, h) + "$lit$" + i.slice(h) + _ + c) : i + _ + (-2 === h ? (n.push(void 0),
          e) : c)
      }
  ...
  class B {
      constructor({strings: t, _$litType$: e}, i) {
          ...
          const r = t.length - 1
            , l = this.parts
            , [a,h] = j(t, e);
          if (this.el = B.createElement(a, i),
  ...
  function L(t, e, i=t, n) {
      ...
      return (null == a ? void 0 : a.constructor) !== h && (null === (o = null == a ? void 0 : a._$AO) || void 0 === o || o.call(a, !1),
      void 0 === h ? a = void 0 : (a = new h(t),
      a._$AT(t, i, n)),
      void 0 !== n ? (null !== (r = (l = i)._$Cl) && void 0 !== r ? r : l._$Cl = [])[n] = a : i._$Cu = a),
      void 0 !== a && (e = L(t, a._$AS(t, e.values), a, n)),
      e
  }
  class I {
      constructor(t, e) {
      ...
      p(t) {
          ...
          const {el: {content: i}, parts: n} = this._$AD
            , s = (null !== (e = null == t ? void 0 : t.creationScope) && void 0 !== e ? e : b).importNode(i, !0);
          D.currentNode = s;
          let o = D.nextNode()
            , r = 0
            , l = 0
          ...
          for (; void 0 !== a; ) {
              if (r === a.index) {
                  let e;
                  2 === a.type ? e = new F(o,o.nextSibling,this,t) : 1 === a.type ? e = new a.ctor(o,a.name,a.strings,this,t) : 6 === a.type && (e = new Z(o,this,t)),
                  this.v.push(e),
                  a = n[++l]
              }
              r !== (null == a ? void 0 : a.index) && (o = D.nextNode(),
              r++)
          }
          return s
      }
  ...
  class F {
      constructor(t, e, i, n) {
          ...
          this._$AM = i,
          this.options = n,
          this._$C_ = null === (s = null == n ? void 0 : n.isConnected) || void 0 === s || s
      }
      get _$AU() {
          var t, e;
      ...
      _$AI(t, e=this) {
          t = L(this, t, e),
          k(t) ? t === M || null == t || "" === t ? (this._$AH !== M && this._$AR(),
          this._$AH = M) : t !== this._$AH && t !== T && this.$(t) : void 0 !== t._$litType$ ? this.T(t) : void 0 !== t.nodeType ? this.k(t) : (t=>x(t) || "function" == typeof (null == t ? void 0 : t[Symbol.iterator]))(t) ? this.O(t) : this.$(t)
      }
      S(t, e=this._$AB) {
      ...
      $(t) {
          this._$AH !== M && k(this._$AH) ? this._$AA.nextSibling.data = t : this.k(b.createTextNode(t)),
          this._$AH = t
      }
      T(t) {
          var e;
          const {values: i, _$litType$: n} = t
            , s = "number" == typeof n ? this._$AC(t) : (void 0 === n.el && (n.el = B.createElement(n.h, this.options)),
          n);
      ...
      _$AC(t) {
          ...
          return void 0 === e && z.set(t.strings, e = new B(t)),
          e
      }
      O(t) {
          x(this._$AH) || (this._$AH = [],
          this._$AR());
          const e = this._$AH;
          let i, n = 0;
          for (const s of t)
              n === e.length ? e.push(i = new F(this.S(w()),this.S(w()),this,this.options)) : i = e[n],
              i._$AI(s),
              n++;
  ...
  class J extends V {
      ...
      _$AI(t, e=this) {
          var i;
          if ((t = null !== (i = L(this, t, e, 0)) && void 0 !== i ? i : M) === T)
              return;
          const n = this._$AH
  ...
  var Q, X;
  null == G || G(B, F),
  (null !== (f = g.litHtmlVersions) && void 0 !== f ? f : g.litHtmlVersions = []).push("2.3.0");
  class Y extends v {
      constructor() {
          super(...arguments),
          this.renderOptions = {
  ...
  Y.finalized = !0,
  Y._$litElement$ = !0,
  null === (Q = globalThis.litElementHydrateSupport) || void 0 === Q || Q.call(globalThis, {
      LitElement: Y
  });
  ...
  let lt = class extends Y {
      constructor() {
          super(...arguments),
          this.api = "http://opengraph.io/api/1.1/site/"
          // this.api = "https://transcendent-eclair-fd16ae.netlify.app/.netlify/functions/meta"
      }
      static get styles() {
          return [ot]
      }
      ...
      firstUpdated() {
          ...
          //const linkurl = `${this.api}${t}?app_id=4c9e50bb-826c-4df1-b889-dbd0970764c4`;
          //console.log(linkurl);
          //const aa = encodeURIComponent("https://www.youtube.com/watch?v=sWbUDq4S6Y8");
          const api_url = "https://opengraph.io/api/1.1/site/"+t+"?app_id=4c9e50bb-826c-4df1-b889-dbd0970764c4";
          fetch(api_url)
          .then((t=>function(t, e, i, n) {
      ...
      get imageSrc() {
          ...
          var imageurl = "https://web-highlights.com/images/fallback-image.png";
          
          if (data.image) {
            imageurl = data.image;
          }
          else if (data.images && data.imageSecureUrl == null) {
            if (data.images.length > 0) {
              imageurl = data.images[0];
            }
          }
          else if (data.imageSecureUrl) {
            imageurl = data.imageSecureUrl;
          }

          return imageurl;
          //return this.loading ? "" : null !== (n = null !== (i = null === (e = null === (t = this.meta) || void 0 === t ? void 0 : t.images[0]) || void 0 === e ? void 0 : e.url) && void 0 !== i ? i : this.imageFallback) && void 0 !== n ? n : this.meta.images[0]
  ...
  ;
  rt([it()], lt.prototype, "api", void 0),
  rt([it()], lt.prototype, "url", void 0),
  rt([it()], lt.prototype, "titleFallback", void 0),
  rt([it()], lt.prototype, "descriptionFallback", void 0),
  rt([it()], lt.prototype, "imageFallback", void 0),
  rt([it()], lt.prototype, "metaData", void 0),
  lt = rt([t=>"function" == typeof t ? ((t,e)=>(customElements.define("webhighlights-link-preview", e),
  e))(0, t) : ((t,e)=>{
